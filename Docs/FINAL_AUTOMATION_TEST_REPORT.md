...
- **Continuous Integration (CI/CD):** Fully configured with both **Jenkins** (`Jenkinsfile`) and **GitHub Actions** (`.github/workflows/automation-tests.yml`).

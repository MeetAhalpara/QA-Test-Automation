...
## Project 3 – Defects and Discrepancies Report
...
**Term:** Summer 2026 | **Institution:** Algonquin College – School of Advanced Technology  
**File Generated:** `Docs/Project 3 - Defects and Discrepancies Report - Devangbhai & Meet.docx`  
...
- **Defect D-01 (High):** *Empty Cart Checkout* — Users can proceed through the entire checkout flow with 0 items.
- **Defect D-02 (Medium):** *Weak Input Validation* — Checkout customer fields accept single-character inputs (`"a"`, `"1"`, `"!"`) without validation constraints.
...
- **Engineering Resolution Applied:** Implemented live JavaScript DOM evaluation in `BasePage`:
  ```javascript
